...
type MatchProperties struct {
	...
	// ResourceAttributes defines a map of resource attribute key to a set of possible values to match metrics against.
	// A match occurs if any resource attribute matches at least one value in this map.
